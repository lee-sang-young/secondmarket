...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "tgQLX9pbifTm4PfTo8bR"; // 네이버API Client ID
	private final static String CLIENT_SECRET = "_PNqTxfzid";
	private final static String REDIRECT_URI = "http://localhost:8080/second";
